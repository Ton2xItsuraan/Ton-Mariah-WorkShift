                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <textarea
                        className="ounded border border-gray-400 focus:outline-none focus:border-[#00BF63] focus:ring-1 focus:ring-[#00BF63] text-base px-4 py-2 resize-none"
                        rows={4}
                        cols={6}
                        {...register("about", {
                          required:
                    ...
                    <div className="mt-4">
                      <CustomButton
                        type="submit"
                        containerStyles="inline-flex justify-center rounded-md border border-transparent bg-[#0C3B2E] px-8 py-2 text-sm font-medium text-white hover:bg-[#00BF63] hover:text-[#0C3B2E] focus:outline-none "
                        title={"Submit"}
                      />
                    </div>
                  </form>
    ...
    <div className="container mx-auto flex items-center justify-center py-10">
      <div className="w-full md:w-2/3 2xl:w-2/4 bg-white shadow-lg p-10 pb-20 rounded-lg">
        <div className="flex flex-col items-center justify-center mb-4">
          ...
          <h5 className="text-[#00BF63] text-base font-bold">
        ...
        <div className="w-full py-10">
          <div className="w-full flex flex-col-reverse md:flex-row gap-8 py-6">
            <div className="w-full md:w-2/3 flex flex-col gap-4 text-lg text-slate-600 mt-20 md:mt-0">
              <p className="text-[#00BF63]  font-semibold text-2xl">ABOUT</p>
            ...
            <div className="w-full md:w-1/3 h-44">
              ...
              />
              <button
                className="w-full md:w-64 bg-[#0C3B2E] text-white mt-4 py-2 rounded"
