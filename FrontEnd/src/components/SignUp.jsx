                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all ">
                  ...
                  <div className="w-full flex items-center justify-center py-4 ">
                    <button
                      className={`flex-1 px-4 py-2 rounded text-sm outline-none ${
                        accountType === "seeker"
                          ? "bg-[#00BF63] text-[#0C3B2E] font-semibold"
                          : "bg-white border border-[#00BF63]"
                      }`}
                  ...
                  >
                    ...
                    <div className="mt-2">
                      <CustomButton
                        type="submit"
                        containerStyles={`inline-flex justify-center rounded-md bg-[#00BF63] px-8 py-2 text-sm font-medium text-white outline-none hover:bg-[#0C3B2E]`}
                  ...
                  <div className="mt-4">
                    <p className="text-sm text-gray-700">
                      ...
                      <span
                        className="text-sm text-[#00BF63] ml-2 hover:text-[#00BF63] hover:font-semibold cursor-pointer"
