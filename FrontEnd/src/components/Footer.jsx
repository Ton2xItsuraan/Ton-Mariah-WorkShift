  ...
  return (
    <footer className="text-white mp-20">
      ...
      <div className="bg-[#00BF63] ">
          ...
          <div className="container mx-auto px-5 pt-6 pb-8 flex flex-wrap items-center justify-between ">
            <div className="w-full md:w-2/4 lg:w-1/3 h-16 flex items-center justify-center md:justify-start ">
              ...
              <CustomButton
                title="Subscribe"
                containerStyles={
                  "block bg-[#0C3B2E] text-white px-5 py-2.5 text-md rounded  hover:bg-black focus:potline-none flex-col items-center mt-2 "
                }
              />
            </div>
        ...
        <div className="bg-[#0C3B2E]">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-gray-300 text-sm text-center sm:text-left">
              &copy; 2024 Made for Job Finder —
              <a
                href="https://youtube.com/@CodeWaveWithAsante"
                className="text-[#00BF63] ml-1"
                target="_blank"
