      ...
      <div className="w-full flex flex-col md:flex-row gap-10">
        ...
        <div className="w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md">
          <div className="w-full flex items-center justify-between">
            <div className="w-3/4 flex gap-2">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-base text-[#00BF63]">
                  {job?.company?.name}
                </span>
            ...
            {selected === "0" ? (
              ...
              <>
                <div className="mb-6 flex flex-col">
                  <p className="text-xl text-[#00BF63] font-semibold">
                    {job?.company?.name}
                  </p>
          ...
          <div className="w-full">
            <CustomButton
              title="Apply Now"
              containerStyles={`w-full flex items-center justify-center text-white bg-[#0C3B2E] py-3 px-5 outline-none rounded-full text-base`}
            />
          </div>
        </div>
