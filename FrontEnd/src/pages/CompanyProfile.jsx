      ...
      <div className="">
            ...
            info?._id === user?.user?._id && (
              <div className="flex items-center justifu-center py-5 md:py-0 gap-4">
                <CustomButton
                  ...
                  iconRight={<FiEdit3 />}
                  containerStyles={`py-1.5 px-3 md:px-5 focus:outline-none bg-[#00BF63]  hover:bg-[#00BF63] text-white rounded text-sm md:text-base border border-[#00BF63]`}
                />
                ...
                <Link to="/upload-job">
                  <CustomButton
                    title="Upload Job"
                    iconRight={<FiUpload />}
                    containerStyles={`text-[#00BF63] py-1.5 px-3 md:px-5 focus:outline-none  rounded text-sm md:text-base border border-[#00BF63]`}
                  />
                </Link>
              </div>
            )}
        ...
        <div className="w-full flex flex-col md:flex-row justify-start md:justify-between mt-4 md:mt-8 text-sm">
          ...
          <div className="flex flex-col items-center mt-10 md:mt-0">
            ...
            <p className="text-[#00BF63] ">Job Post</p>
          </div>
        </div>
      </div>
